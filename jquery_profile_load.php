...
$sql_community_profiles = "SELECT * FROM profiles INNER JOIN users ON profiles.user_id = users.id WHERE profiles.id = '$profile_id'";
$community_profiles_result = $connection->query($sql_community_profiles);
