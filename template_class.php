            ...
            <div class="container-fluid" ng-show="authenticated">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Communities <span class="badge" ng-show="invitedCounter != 0" ng-bind="invitedCounter"></span> <span class="caret"></span></a>
