...
if (mysqli_fetch_row($resultCheck)) {
        ...
        $query = "SELECT markers.marker_id, profiles.profile_id, phone_01, phone_02, email_01, email_02, pin_color, username, name, location, community_name, users.password, users.email
