...
if (mysqli_num_rows($sql_does_community_exists_result) == 0) {
    ...
    $sql_community_information = "SELECT * FROM markers_to_communities INNER JOIN markers ON markers_to_communities.marker_id = markers.marker_id INNER JOIN config ON markers_to_communities.community_id = config.community_id WHERE markers_to_communities.community_id = '$community_id'";
