...
?>
   ...
   <script src="controllers/communitysearch_controller.js"></script>
   <body ng-controller="communitysearchController">
               ...
               <div ng-show="show_side_version">
                  ...
                  <table class="table  table-borderless table-responsive table-striped">
                     ...
                     <tr> 
                        ...
                        <td> {{ communities[row_clicked].state }} </td> 
                     </tr>
                     <tr> 
                        <th style="color: #006699"> Country: </th> 
                        <td> {{ communities[row_clicked].country }} </td> 
                     </tr>
                     <tr> 
                        <th style="color: #006699"> Description: </th> 
                        <td> {{ communities[row_clicked].community_description }} </td> 
                     </tr>
                  </table>
                  <div align="center">
               ...
               <div ng-show="!show_side_version">
                  ...
                  <table class="table tabledetail table-striped table-hover ">
                     ...
                     <tr>
                        <th></th>
                        <td>
                           <button type="button" class="btn btn-primary btn-sm" style="width:100%" id="submit_search" ng-click="submit_search();">Search</button>
                        </td>
                     </tr>
                  </table>
               </div>
      ...
      <!-- Modal -->
      <div id="join_community_modal" class="modal fade" role="dialog">
         <div class="modal-dialog">
            <!-- Modal content -->
            <div class="modal-content">
               <div class="modal-header">
               ...
               <div class="modal-body">
                  <b> Would you like to join this community? </b> <br />
                  <span id="joinCommunityErrorMessage" style="color: red;"> </span>
                  <span id="joinCommunitySuccessMessage" style="color: green;"> </span>
               </div>
               <div class="modal-footer">
